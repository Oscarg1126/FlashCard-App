...
<form onSubmit={handleSubmit}>
  <div className="form-group">
    ...
    <input type="name" className="form-control" id="exampleFormControlInput1" value={front}/>
  </div>
  <div className="form-group">
    <label for="exampleFormControlTextarea1">Back</label>
    <textarea className="form-control" id="exampleFormControlTextarea1" rows="3" value={back}></textarea>
  </div>
